...
contract VotingEscrow is IERC721, IERC721Metadata, IVotes, Ownable {
    ...
    /// @param token_addr `HSK` token address
    ...
    function approve(address _approved, uint _tokenId) public {
        ...
        bool senderIsApprovedForAll = (ownerToOperators[tokenOwner])[
            msg.sender
        ];
    ...
    uint internal constant MAXTIME = 52 * 7 * 86400; //@audit updated from 26 to 52, alongside with error messages
    int128 internal constant iMAXTIME = 52 * 7 * 86400; //@audit updated from 26 to 52
    ...
    function _create_lock(
        ...
        require(
            ...
            "Voting lock can be 52 weeks max"
        );
